...
- saída minimalista contendo apenas:
  - `registro_uid`
  - `raw_text`
- uso de PyMuPDF e pdfplumber para garantir cobertura de texto e tabelas, e tambem de B4S para html
...
├── data/
│   ├── benchmark/
│   │   |── benchmark_questions_v1.json
│   │   |── benchmark_questions_v2.json
│   │   └── benchmark_questions_v3.json  
│   ├── raw/
│   │   ├── json/
│   │   ├── metadata/
│   │   ├── selected/
...
│   │   |── 03_create_chunks.py
│   │   |── 04_prepare_retrieval_corpus.py
│   │   |── 05a_import_to_sqlites.py
│   |   └── 05b_create_bm25_index.py
│   ├── retrieval/
│   │   ├── evaluations/
│   │   |   |── evaluate_bm25.py
│   │   |   └── evaluate_utils.py   
