...
from archive.deprecated.retrieval.hybrid_retriever import build_hybrid_retriever

@dataclass(frozen=True)
class EvaluateHybridConfig:
    base_dir: Path = Path(__file__).resolve().parent.parent.parent.parent
    benchmark_path: Path = base_dir / "data" / "benchmark" / "benchmark_questions_v1.json"
