...
from archive.deprecated.retrieval.semantic_retriever import SemanticRetriever, SemanticConfig, build_semantic_retriever
...
def parse_args():
    ...
    parser.add_argument("--weight-bm25", type=float, default=0.80)
    parser.add_argument("--weight-semantic", type=float, default=0.05)
